...
| 维度 | 我们做了什么 |
|------|--------------|
| **自动路由 (V4)** | 全自动「赏金猎犬」后台组合管理器。扫描最高 ROI 的市场，对落后市场执行平滑换仓 (Graceful Exit)，在不超限的情况下无缝替补新市场。 |
...
- **V4.0 自动路由 (Portfolio Manager)** — 开启后即可 7x24 无人值守运行。周期性扫描 Gamma API，基于日化 ROI 排名进行动态优胜劣汰。支持旧市场「只卖不买」的平滑退场与新市场的无缝替补。

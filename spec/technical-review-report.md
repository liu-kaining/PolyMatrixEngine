...
> **ARCHIVED / 不可作为当前运行手册。** 本文是 2026-03-23 整改前快照，包含已删除的 Hard Reset、force-evict、旧 PnL 和旧状态解释。当前结论与实施状态只以 [`LIVE_TRADING_REMEDIATION_PLAN.md`](./LIVE_TRADING_REMEDIATION_PLAN.md)、根目录 README 和当前代码为准；当前实盘状态是 **NO-GO**。
